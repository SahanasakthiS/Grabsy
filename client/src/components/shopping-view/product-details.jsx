...
function ProductDetailsDialog({open, setOpen, productDetails}){
    ...
    return(
        <Dialog open={open} onOpenChange={handleDialogClose}>
            <DialogContent className="grid grid-cols-2 gap-8 sm:p-12 max-w-[10vw] sm:max-w-[80vw] lg:max-w-[60vw]">
                ...
                <div className="">
                    <div>
                        <h1 className="text-3xl font-extrabold mb-5">{productDetails?.title}</h1>
                    ...
                    <div className="mt-5 mb-5">
                        {
                             ...
                             productDetails?.totalStock === 0 ? <Button className="opacity-60 w-full cursor-not-allowed">Out of stock</Button>
