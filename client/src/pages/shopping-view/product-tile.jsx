...
function ShoppingProductTile({product, handleGetProductDetail, handleAddToCart}){
    return(
...
${product?.price}</span>
                        ...
                        <span className="ext-lg font-semibold text-primary">${product?.salePrice}</span> : null}
                     </div>
                </CardContent>
            </div>
            <CardFooter>
                {
                    product?.totalStock === 0 ? <Button className="opacity-60 w-full cursor-not-allowed">Out of stock</Button>
